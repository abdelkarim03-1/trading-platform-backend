package com.tradeswift.config;
import com.tradeswift.config.jwt.JwtTokenValidation;
        ...
        return new CorsConfigurationSource() {
            ...
            public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                ...
                cf.setAllowedOrigins(
                        Arrays.asList("http://localhost:5175","http://localhost:5174","https://main--treading.netlify.app/")
                );
